...
const About = () => {
  ...
  return (
    <section id="about" className="relative w-full bg-[#000000] py-24 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        >
          ...
          <p className="text-gray-400 mt-3 text-lg font-medium">Get to know me</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <h3 className="text-white text-2xl md:text-3xl font-bold mb-6 leading-tight">
              Crafting <span className="text-[#00ff99]">Digital Experiences</span> with Precision
            </h3>
            
            <p className="text-gray-300 text-lg leading-relaxed max-w-lg mb-8">
              I am a Computer Science student currently studying in 2nd year. I have a strong interest in frontend development and building modern, responsive websites. I have experience working with HTML, CSS, JavaScript, and React, and I enjoy creating clean and user-friendly interfaces.
            </p>
            ...
            <div className="grid grid-cols-2 gap-6 w-full max-w-md">
              <div className="flex flex-col gap-2">
                ...
                <p className="text-gray-500 text-sm italic">Clean & minimal designs</p>
              </div>
              <div className="flex flex-col gap-2">
                <div className="flex items-center gap-2 text-[#00ff99]">
                  <Smartphone size={20} />
                ...
                <p className="text-gray-500 text-sm italic">Mobile-first approach</p>
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="relative bg-[#0a0a0a] border border-gray-800 rounded-2xl p-8 transition-all duration-500 hover:border-[#00ff99]/50 group shadow-2xl">
              <div className="flex items-center gap-3 mb-8">
                <div className="w-12 h-12 flex items-center justify-center rounded-xl bg-[#00ff99]/10 text-[#00ff99] group-hover:scale-110 transition-transform duration-300">
                  <GraduationCap size={24} />
                </div>
                <h3 className="text-white font-bold text-xl uppercase tracking-widest">Education</h3>
              </div>
